...
def standardize_format(data: List[Dict]) -> List[Dict]:
    ...
    for row in data:
        ...
        if 'CustomerID' in row:
            standardized_row['CustomerID'] = standardize_id(row['CustomerID'], prefix='CUST')
        ...
        if 'Age' in row:
            standardized_row['Age'] = standardize_numeric(row['Age'], data_type=int)
        if 'PurchaseAmount' in row:
            standardized_row['PurchaseAmount'] = standardize_numeric(row['PurchaseAmount'], data_type=float)
